...
> 生成时间：2026-07-22T16:39:40+08:00

## 结论

已成功导出 **243 个有效 SWF 容器**，共 **110,317 个文件**（**4.33 GB**）。导出失败和超时均为 0。
...
| 类型目录 | 文件数 | 大小 |
| --- | --- | --- |
| binaryData | 8 | 6.01 MB |
| buttons | 2,115 | 22.43 MB |
| fonts | 54 | 13.30 MB |
| frames | 232 | 1.47 MB |
| images | 8,946 | 593.35 MB |
| morphshapes | 8 | 13.60 KB |
| scripts | 12,762 | 75.60 MB |
| shapes | 16,094 | 1.25 GB |
| sounds | 185 | 7.86 MB |
| sprites | 69,175 | 2.38 GB |
| symbolClass | 224 | 95.81 KB |
| texts | 514 | 4.40 KB |
